...
export class CustomerComponent implements OnInit {
  ...
  constructor(private modalService: NgbModal, private _movies: MoviesService) { }
  ...
  openModal(nombreMovie: string) {
    ...
    modalRef.componentInstance.data = this.Peliculas.find(x => x.NomPelicula === nombreMovie);
  }
}
